...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Group of libraries at <b>pytorch</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    ...
    public static class PytorchLibraryAccessors extends SubDependencyFactory {
        ...
        private final PytorchTorchvisionLibraryAccessors laccForPytorchTorchvisionLibraryAccessors = new PytorchTorchvisionLibraryAccessors(owner);

        public PytorchLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>pytorch.android</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        ...
        /**
         * Group of libraries at <b>pytorch.torchvision</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public PytorchTorchvisionLibraryAccessors getTorchvision() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForPytorchTorchvisionLibraryAccessors;
        }
    ...
    public static class PytorchAndroidLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>lite</b> with <b>org.pytorch:pytorch_android_lite</b> coordinates and
         * with version reference <b>pytorchAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
     ...
     */
    @Deprecated
    public static class PytorchTorchvisionLibraryAccessors extends SubDependencyFactory {

        public PytorchTorchvisionLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>lite</b> with <b>org.pytorch:pytorch_android_torchvision</b> coordinates and
         * with version reference <b>pytorchAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getLite() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("pytorch.torchvision.lite");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>pytorchAndroid</b> with value <b>2.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPytorchAndroid() { return getVersion("pytorchAndroid"); }
